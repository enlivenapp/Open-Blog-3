...
('enable_atom_comments', '1', 'feed', 'dropdown', '1=yes|0=no', 1),
('enable_atom_posts', '1', 'feed', 'dropdown', '1=yes|0=no', 1),
('enable_rss_comments', '1', 'feed', 'dropdown', '1=yes|0=no', 1),
('enable_rss_posts', '1', 'feed', 'dropdown', '1=yes|0=no', 1),
