...
{
	echo '<p>Welcome to the Open Blog Installation</p>
	...
	<p align="center"><input type="button" name="submit" value="Start installation &rsaquo;&rsaquo;" class="styled" onClick="window.location =\'install.php?step=1\'" /></p>';
}
