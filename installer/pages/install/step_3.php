...
if ($_POST['submit'] != "")
{
	...
	$blog['admin_email'] = $_POST['blog_admin_email'];
	...
	if (empty($database['hostname']) || empty($database['username']) || empty($database['password']) || empty($database['name']) || empty($database['prefix']) || empty($blog['url']) || empty($blog['title']) || empty($blog['description']) || empty($blog['admin_email']) || empty($blog['meta_keywords']) || empty($blog['posts_per_site']) || empty($blog['links_per_box']) || empty($blog['months_per_archive']) || empty($administrator['username']) || empty($administrator['password']) || empty($administrator['email']))
	{
