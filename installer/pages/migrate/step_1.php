...
<tr>
	<td style="text-align: left">
		<input type="button" name="submit" value="&lsaquo;&lsaquo; Cancel" class="styled" onClick="window.location = 'migrate.php'" />
	</td>
	<td style="text-align: right">
		<?php if ($error == 1): ?>
			<input type="button" name="submit" value="Refresh" class="styled" onClick="window.location.reload()" />
		<?php else: ?>
			<input type="button" name="submit" value="Step 2 &rsaquo;&rsaquo;" class="styled" onClick="window.location = 'migrate.php?step=2'" />
		<?php endif; ?>
	</td>
</tr>
</table>