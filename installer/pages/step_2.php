	...
	<td>
    	...
    	<table>
	   		<tr>
	        	...
	        	<td><input type="text" name="blog_url" value="http://www.yoursite.com/blog/" id="blog_url" size="35" class="styled"  /></td>
	        </tr>
        </table>
	</td>
</tr>
...
<tr>
	<td style="text-align: left">
		<input type="button" name="step_1" value="&lsaquo;&lsaquo; Step 1" class="styled" onClick="window.location = 'index.php?step=1'" />
	</td>
