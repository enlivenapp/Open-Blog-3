...
INSERT INTO `ob_categories` (`id`, `name`, `url_name`, `description`) VALUES(1, 'Uncategorized', 'uncategorized', 'Uncategorized');
...
INSERT INTO `ob_languages` (`id`, `language`, `abbreviation`, `author`, `author_website`, `is_default`) VALUES(1, 'english', 'en', 'Tomaz Muraus', 'http://www.open-blog.info', '1');
INSERT INTO `ob_languages` (`id`, `language`, `abbreviation`, `author`, `author_website`, `is_default`) VALUES(2, 'slovene', 'sl', 'Tomaz Muraus', 'http://www.open-blog.info', '0');
...
INSERT INTO `ob_navigation` (`id`, `title`, `description`, `url`, `external`, `position`) VALUES(1, 'Home', 'Index', 'index.php', '0', 1);
INSERT INTO `ob_navigation` (`id`, `title`, `description`, `url`, `external`, `position`) VALUES(2, 'Archive', 'Archive', 'blog/archive/', '0', 2);
...
# Table: 'ob_posts_to_categories' data
INSERT INTO `ob_posts_to_categories` (`post_id`, `category_id`) VALUES(1, 1);
...
# Table: 'ob_tags' data
INSERT INTO `ob_tags` (`id`, `name`) VALUES(1, 'codeigniter');
INSERT INTO `ob_tags` (`id`, `name`) VALUES(2, 'blog');
