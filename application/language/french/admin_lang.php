...
// Settings
$lang['settings_help_txt']					= "Les options permettent de changer la manière dont votre site web effectue certaines actions ainsi que des informations basiques telles que le nom du site.";
$lang['allow_comments_label']				= "Autoriser les commentaires";
$lang['allow_comments_desc']				= "Voullez vous autoriser les commentaires sur le post de votre blog?";
$lang['base_controller_label']				= "Controlleur de base (BETA)";
...
$lang['category_list_limit_desc']			= "Choisissez combien d'elements vous souhaitez afficher lorsque les catégories sont affichés sur la page d'acceuil.";
...
$lang['mod_user_comments_label']			= "Modérer les commentaires utilisateur";
$lang['mod_user_comments_desc']				= "Voullez vous modérer les utilisateurs enregistrés?";
$lang['months_per_archive_label']			= "Limite des Archives";
$lang['months_per_archive_desc']			= "Choisissez combien d'elements vous souhaitez afficher lorsque les archives sont affichés sur la page d'acceuil.";
$lang['posts_per_page_label']				= "Limite de posts par pages";
...
$lang['use_recaptcha_desc']					= 'Souhaitez vous activer les Captcha Google pour aider à éliminer les SPAM et la modération des commentaires? <a href="https://www.google.com/recaptcha/intro/" target="_blank">More Info <sup><i class="fa fa-external-link"></i></sup></a>';
$lang['use_honeypot_label']					= "EActiver les Honey Pots pour les formulaires";
$lang['use_honeypot_desc']					= "Pour vous aider à éviter les spams, vous pouvez utiliser un Honey Pot: le spammer va remplir des formulaires invisibles qu ne doivent pas l'être. Cela va protéger vos commentaires et les formulaires d'enregistrements des robots, mais pas des humains. ";
...
$lang['smtp']								= 'SMTP (Nécéssite un compte mail smtp EX: votre server, google, yahoo, etc)';
...
$lang['sendmail_path_desc']					= "(Nécéssaire si vous utilisez SENDMAIL) Entrez le chemin vers SENDMAIL. Généralement disponible dans le panneau de controle de votre serveur.";
$lang['smtp_user_label']					= "Utilisateur SMTP";
$lang['smtp_user_desc']						= "(Nécéssaire si vous utilisez SMTP) Entrez le nom d'utilisateur de votre compte SMTP.";
$lang['smtp_host_label']					= "Hôte SMTP";
$lang['smtp_host_desc']						= "(Nécéssaire si vous utilisez SMTP) Entrez l'hôte de votre compte SMTP.  (EX: google.com, mail.yourdomain.com, etc)";
$lang['smtp_pass_label']					= "SMTP Password";
$lang['smtp_pass_desc']						= "(Nécéssaire si vous utilisez SMTP) Entrez le mot de passe de votre compte SMTP.";
$lang['smtp_port_label']					= "SMTP Port";
$lang['smtp_port_desc']						= "(Nécéssaire si vous utilisez SMTP) Entrez le port renseigné par l'hôte de votre serveur SMTP.";
$lang['admin_email_label']					= "EMail Admin";
$lang['admin_email_desc']					= "L'adresse email sur laquelle vous souhaitez recevoir des notifications à propos du site.";
$lang['server_email_label']					= "Email Serveur";
$lang['server_email_desc']					= "L'adreese Email avec laquelle vous souhaitez que le serveur envoit les mails. Cela peut êtres 'noreply@' ('nepasrepondre@'') ou votre email afin que les utilisateur puissent répondre à un humain.";


$lang['email_activation_label']					= "Activation par Email";
$lang['email_activation_desc']					= "Souhaitez vous que les utilisateur vérifient le compte par email avant de pouvoir se connecter et commenter? (Option recommendée)";
...
$lang['allow_registrations_desc']				= "Souhaitez vous autoriser la créetion du compte pour votre blog?";
...
$lang['add_link_subheading']				= "Ajoutez les informations du lien. Ce sont des leins externes, assurez vous de faire précéder votre lien par http:// ou https://.";
...
$lang['link_added_fail_resp']				= "Impossible d'jouter le lien. Esseyez ultérieurement.";
$lang['link_removed_success_resp']			= "Lien supprimé avec succès.";
$lang['link_removed_fail_resp']				= "Impossible de supprimer le lien. Esseyez ultérieurement.";
$lang['link_update_success_resp']			= "Lien mis à jour avec succès";
$lang['link_update_fail_resp']				= "Impossible de supprimer le lien. Esseyez ultérieurement.";
...
$lang['cat_added_fail_resp']				= "Impossible d'ajouter la cotégorie. Esseyez ultérieurement.";
$lang['cat_removed_success_resp']			= "Catgorie supprimée avec succès";
$lang['cat_removed_fail_resp']				= "Impossible de supprimer la catégorie. Esseyez ultérieurement.";
$lang['cat_update_success_resp']			= "Catégorie mise à jour avec succès";
$lang['cat_update_fail_resp']				= "Impossible de mètre à jour la catégorie. Esseyez ultérieurement.";
...
$lang['optional_hdr']						= "Optionel";
$lang['optional_help_text']					= "Bien que les options ci-dessous soit optionels, Elles sont fortement recommendés et aident grandement la Search Engine Optimization (SEO: Optimisation du moteur de recherche). Nous générons aussi des meta tags pour facebook et twitter avec ces valeurs.";
$lang['post_remove_btn']					= "Supprimer le Post";
$lang['post_edit_btn']						= "Éditer Post";
...
$lang['post_added_fail_resp']				= "Impossible d'ajouter le post. Esseyez ultérieurement.";
$lang['post_removed_success_resp']			= "Post supprimé avec succès";
$lang['post_removed_fail_resp']				= "Impossible de supprimer le post.  Esseyez ultérieurement.";
$lang['post_update_success_resp']			= "Post mis à jour avec succès";
$lang['post_update_fail_resp']				= "Impossible de mètre à jour le post.  Esseyez ultérieurement.";
...
$lang['post_form_status_help_text']			= "Choisisser si vous voullez que le post soit en ligne ou un brouillon.";
...
$lang['post_form_cats_help_text']			= "Choisissez une catégorie.  Pour en choisir plusieurs, pressez CMD/CTRL + Clickez sur vos choix.";
...
$lang['post_form_meta_desc_help_text']		= "Entrez la description. Il vaut mieux la restreindre entre 50 et 100 caractères.";
$lang['post_form_home_text']				= "Page d'acceuil";
$lang['post_form_home_help_text']			= "Checkez cette case si ce post est la page d'acceuil. Vous devez choissir les posts comme étant le controlleur par défaut dans les options. Tou autre post marqué comme page d'acceuil sera supprimé de la page d'acceuil.";
...
$lang['nav_right_side_desc']				= "Ci-dessous, redirigez vous vers un poste spécifique. Leave all options blank to point to your homepage.";
