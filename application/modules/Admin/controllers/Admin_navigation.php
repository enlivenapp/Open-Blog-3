...
class Admin_navigation extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->template->set('active_link', 'navs');
	...
	{	
		...
		if ($this->form_validation->run() == TRUE)
        {
			...
			$this->template->build('navigation/add_nav', $data); 
        }
        $this->template->build('navigation/add_nav', $data);       
	}
	...
	public function edit($id)
	{
		...
		if ($this->form_validation->run() == TRUE)
        {
			...
			$this->template->build('navigation/edit_nav', $data); 
        }
        $this->template->build('navigation/edit_nav', $data);    
