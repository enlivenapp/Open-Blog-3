...
class Admin_users extends Admin_Controller {
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->template->build('users/deactivate_user', $data);
		}
		else
		{
	...
	public function create_user()
    {
        ...
        else
        {
            ...
            $this->template->build('users/create_user', $this->data);
        }
    }
	...
	public function create_group()
	{
		...
		else
		{
			...
			$this->template->build('users/create_group', $this->data);
		}
	}
	...
	public function edit_group($id)
	{
		...
		$this->template->build('users/edit_group', $data);
	}
	...
	public function edit_perm($id)
	{
		...
		$this->template->build('users/edit_perm', $data);
	}
