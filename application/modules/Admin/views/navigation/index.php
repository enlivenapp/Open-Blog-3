...
<p><a class="btn btn-default btn-sm" href="<?php echo site_url('admin/admin_navigation/add_nav') ?>"><?php echo lang('index_add_new_nav') ?></a></p>
            ...
            <ul class="list-group m-t-l" id="sortable">
                <?php foreach ($navs as $nav): ?>
                    <li class="list-group-item" id="item-<?= $nav->id ?>">
                        ...
                        <a href="<?= base_url('admin/admin_navigation/edit/' . $nav->id) ?>" class="btn btn-default btn-xs">Edit</a> 
                        <a href="<?= base_url('admin/admin_navigation/remove_nav/' . $nav->id) ?>" class="btn btn-danger btn-xs">Delete</a> 
                ...
                $('#sortable').sortable({
                    ...
                    update: function (event, ui) {
                        ...
                        $.ajax({
                            data: data,
                            type: 'POST',
                            url: '<?= base_url("admin/admin_navigation/update_nav_order") ?>'
                        });
                    }
                });
            </script>
        ...
        <div role="tabpanel" class="tab-pane fade" id="redirects">
            ...
            <table class="table table-condensed">
                ...
                <?php foreach ($redirects as $redir): ?>
                    ...
                    <td><?= $redir->code ?></td>
                    <td class="text-right">
                        <a href="<?= site_url('admin/admin_navigation/edit_redirect/' . $redir->id) ?>" class="btn btn-default btn-xs"><?= lang('redir_edit_btn') ?></a>
                        <a href="<?= site_url('admin/admin_navigation/remove_redirect/' . $redir->id) ?>" class="btn btn-danger btn-xs"><?= lang('redir_remove_btn') ?></a>
                    </td>
                </tr>
              <?php endforeach ?>
            </table>
